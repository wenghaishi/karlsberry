...
const HeroSection = () => {
  return (
    <div className="h-screen md:h-screen hero z-20 flex flex-col justify-center items-center">
      <Parallax className="z-20">
        <div className="flex flex-col justify-center mt-40 items-center gap-16">
          <h1 className="z-40 md:text-6xl text-slate-600">
            Your favourite sparkling tea!
          </h1>
          <p className=" text-sm md:text-2xl w-1/2 z-20">
