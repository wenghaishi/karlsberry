...
const About = () => {
  return (
    <div className="about flex justify-center">
      ...
      <div className="flex flex-row justify-center items-center gap-16 mt-16">
        <img src="about.gif" alt="" className="rounded-lg drop-shadow-sm	"/>
        <p className="w-1/2 text-lg place-self-center ">
          A father & son’s love. Ever since my dear son was born in 2019, we would
          ...
          my son, he could sense the despair within. One day in 2023 he told me,
          ...
          boy, Karl. Karl loves apples and blackberries. Every time he drinks
          ...
          caffeine and great for kids. We hope that every time you enjoy a
